...
public class BehaviorTest {
    ...
    public void Tunnel_Basic() {
        ...
        assertTrue("Server has the wrong name", TestUtilities.mrNames[0].equals(tunnel.getName()));
        assertTrue("Server toString does not function as expected", String.format("%s", TestUtilities.mrNames[0]).equals(tunnel.toString()));
    }
